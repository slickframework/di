...
var Search = {
    ...
    loadIndex : function(url) {
        jQuery.ajax({type: "GET", url: url, data: null,
    ...
    performSearch : function(query) {
        ...
        this.output = jQuery('<ul class="search list-view"/>').appendTo(this.out);
    ...
    query : function(query) {
        ...
        var highlightstring = '?highlight=' + jQuery.urlencode(hlterms.join(" "));
        ...
        function displayNextItem() {
            ...
            if (results.length) {
                ...
                if (DOCUMENTATION_OPTIONS.FILE_SUFFIX === '') {
                    ...
                    itemTitle.html(jQuery('<a/>').attr('href',
                ...
                if (item[3]) {
                    ...
                    jQuery.ajax({url: DOCUMENTATION_OPTIONS.URL_ROOT + '_sources/' + item[5] + (item[5].slice(-suffix.length) === suffix ? '' : suffix),
                        dataType: "text",
                        complete: function(jqxhr, textstatus) {
    ...
    performTermsSearch : function(searchterms, excluded, terms, titleterms) {
        ...
        for (file in fileMap) {
            ...
            if (valid) {
                ...
                results.push([filenames[file], titles[file], '', null, score, filenames[file]+'.txt']);
            }
        }
        return results;
    },
    ...
    makeSearchSummary : function(text, keywords, hlwords) {
        ...
        var excerpt = ((start > 0) ? '...' : '') +
            jQuery.trim(text.substr(start, 240)) +
            ((start + 240 - text.length) ? '...' : '');
        var rv = jQuery('<div class="context"></div>').text(excerpt);
        jQuery.each(hlwords, function() {
