...
!function(e,t){"function"==typeof define&&define.amd?define(["jquery"],function(n){return t(e,n)}):"object"==typeof module&&"object"==typeof module.exports?module.exports=t(e,require("jquery")):e.lity=t(e,e.jQuery||e.Zepto)}("undefined"!=typeof window?window:this,function(e,t){"use strict";function n(){v[m>0?"addClass":"removeClass"]("lity-active")}function i(e){var n=t.Deferred();return k?(e.one(k,n.resolve),setTimeout(n.resolve,500)):n.resolve(),n.promise()}function r(e,n,i){if(1===arguments.length)return t.extend({},e);if("string"==typeof n){if("undefined"==typeof i)return"undefined"==typeof e[n]?null:e[n];e[n]=i}else t.extend(e,n);return this}function o(){return"file:"===e.location.protocol?"http:":""}function a(e){for(var t,n=decodeURI(e).split("&"),i={},r=0,o=n.length;r<o;r++)n[r]&&(t=n[r].split("="),i[t[0]]=t[1]);return i}function l(e,n){return e+(e.indexOf("?")>-1?"&":"?")+t.param(n)}function d(e){return t('<span class="lity-error"/>').append(e)}function s(e){if(!h.test(e))return!1;var n=t('<img src="'+e+'">'),i=t.Deferred(),r=function(){i.reject(d("Failed loading image"))};return n.on("load",function(){return 0===this.naturalWidth?r():void i.resolve(n)}).on("error",r),i.promise()}function u(e){var n;try{n=t(e)}catch(e){return!1}if(!n.length)return!1;var i=t('<span style="display:none !important" class="lity-inline-placeholder"/>');return n.after(i).on("lity:ready",function(e,t){t.one("lity:remove",function(){i.before(n.addClass("lity-hide")).remove()})})}function c(e){var n,i=e;return n=g.exec(e),n&&(i=l(o()+"//www.youtube"+(n[2]||"")+".com/embed/"+n[4],t.extend({autoplay:1},a(n[5]||"")))),n=w.exec(e),n&&(i=l(o()+"//player.vimeo.com/video/"+n[3],t.extend({autoplay:1},a(n[4]||"")))),n=x.exec(e),n&&(i=l(o()+"//www.google."+n[3]+"/maps?"+n[6],{output:n[6].indexOf("layer=c")>0?"svembed":"embed"})),'<div class="lity-iframe-container"><iframe frameborder="0" allowfullscreen src="'+i+'"></iframe></div>'}function f(e){function o(e){27===e.keyCode&&u()}function a(){var e=y.documentElement.clientHeight?y.documentElement.clientHeight:Math.round(p.height());v.css("max-height",Math.floor(e)+"px").trigger("lity:resize",[f,c])}function l(e){f&&(v=t(e),p.on("resize",a),a(),f.find(".lity-loader").each(function(){var e=t(this);i(e).always(function(){e.remove()})}),f.removeClass("lity-loading").find(".lity-content").empty().append(v),v.removeClass("lity-hide").trigger("lity:ready",[f,c]),w.resolve())}function d(e,i,r){m++,n(),f=t(r.template).addClass("lity-loading").appendTo("body"),r.esc&&p.one("keyup",o),setTimeout(function(){f.addClass("lity-opened lity-"+e).on("click","[data-lity-close]",function(e){t(e.target).is("[data-lity-close]")&&u()}).trigger("lity:open",[f,c]),t.when(i).always(l)},0)}function s(e,n){var i,r,o=t.extend({},b,g);if(n.handler&&o[n.handler])r=o[n.handler](e,c),i=n.handler;else{var a={};t.each(["inline","iframe"],function(e,t){o[t]&&(a[t]=o[t]),delete o[t]});var l=function(t,n){return!n||(r=n(e,c),r?(i=t,!1):void 0)};t.each(o,l),i||t.each(a,l)}return r&&(w=t.Deferred(),t.when(u()).done(t.proxy(d,null,i,r,n))),!!r}function u(){if(f){var e=t.Deferred();return w.done(function(){m--,n(),p.off("resize",a).off("keyup",o),v.trigger("lity:close",[f,c]),f.removeClass("lity-opened").addClass("lity-closed");var t=f,r=v;f=null,v=null,i(r.add(t)).always(function(){r.trigger("lity:remove",[t,c]),t.remove(),e.resolve()})}),e.promise()}}function c(e){if(!e.preventDefault)return c.open(e);var n=t(this),i=n.data("lity-target")||n.attr("href")||n.attr("src");if(i){var r=t.extend({},C,h,n.data("lity-options")||n.data("lity"));s(i,r)&&e.preventDefault()}}var f,v,h={},g={},w=t.Deferred().resolve();return c.handlers=t.proxy(r,c,g),c.options=t.proxy(r,c,h),c.open=function(e){return s(e,t.extend({},C,h)),c},c.close=function(){return u(),c},c.options(e)}var y=e.document,p=t(e),v=t("html"),m=0,h=/\.(png|jpe?g|gif|svg|webp|bmp|ico|tiff?)(\?\S*)?$/i,g=/(youtube(-nocookie)?\.com|youtu\.be)\/(watch\?v=|v\/|u\/|embed\/?)?([\w-]{11})(.*)?/i,w=/(vimeo(pro)?.com)\/(?:[^\d]+)?(\d+)\??(.*)?$/,x=/((maps|www)\.)?google\.([^\/\?]+)\/?((maps\/?)?\?)(.*)/i,b={image:s,inline:u,iframe:c},C={esc:!0,handler:null,template:'<div class="lity" tabindex="-1"><div class="lity-wrap" data-lity-close><div class="lity-loader">Loading...</div><div class="lity-container"><div class="lity-content"></div><button class="lity-close" type="button" title="Close (Esc)" data-lity-close>×</button></div></div></div>'},k=function(){var e=y.createElement("div"),t={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var n in t)if(void 0!==e.style[n])return t[n];return!1}();return f.version="1.5.1",f.handlers=t.proxy(r,f,b),f.options=t.proxy(r,f,C),t(y).on("click","[data-lity]",f()),f});
...
!function(){var a=window.location.hash?window.location.hash:null,i=$(".sidebar .toctree-l1 li a");$(".sidebar > ul").addClass("sidenav").addClass("dropable").addClass("sticky"),$(".sidebar > ul .current").addClass("active");var n=!1;i.each(function(i,e){e.hash==a&&($(e).addClass("active"),n=!0)}),n||jQuery(".sidebar > ul .current ul a").first().addClass("active"),i.on("click",function(a){$(this).parent("li").parent("ul").find("li > a").removeClass("active"),$(this).addClass("active")}),$(".highlight pre").each(function(a,i){var n=$(i).parent("div").parent("div").attr("class"),e=n.replace("highlight-","");$(i).attr("data-language",e);var t=$(i).html(),s=$("<code />");s.html(t),$(i).html(s),s.addClass("language-"+e)}),$(".headerlink").each(function(a,i){var n=$(i).parent();n.is("h1")||n.attr("id",$(i).attr("href").substring(1)),$(i).remove()}),$(".admonition-title").each(function(a,i){var n=$(i).parent(),e=$("<h4 />");e.html($(i).text()),n.prepend(e),$(i).remove()}),$(".admonition.note h4").prepend('<i class="fa fa-info"></i>&nbsp;'),$(".admonition.important h4").prepend('<i class="fa fa-flash"></i>&nbsp;'),$(".admonition.tip h4").prepend('<i class="fa fa-graduation-cap"></i>&nbsp;'),$(".admonition.hint h4").prepend('<i class="fa fa-lightbulb-o"></i>&nbsp;'),$(".admonition.warning h4").prepend('<i class="fa fa-warning"></i>&nbsp;'),$(".admonition.attention h4").prepend('<i class="fa fa-exclamation"></i>&nbsp;'),$(".admonition.error h4").prepend('<i class="fa fa-times-circle-o"></i>&nbsp;'),$(".admonition.danger h4").prepend('<i class="fa fa-exclamation-triangle"></i>&nbsp;'),$(".admonition.caution h4").prepend('<i class="fa fa-exclamation-triangle"></i>&nbsp;'),$(".rst-current-version").on("click",function(a){$(".rst-other-versions").toggle()})}(jQuery);
$(function(){"use strict";$("#scroll-up").on("click",function(){return $("html, body").animate({scrollTop:0},900),!1}),$(".toc a, .sidenav.nav a").click(function(){return $("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-80},500),!1});var e=location.hash.replace("#","");if(""!=e&&$("#"+e).length>0&&$("html, body").animate({scrollTop:$("#"+e).offset().top-100},600),$(window).height()>$("body").height()){var i=$(window).height()-$(".site-header").height()-$(".site-footer").height();$("body > main").css("min-height",i)}if($(".sidenav.sticky").length>0){var t=$(window).height()-$(".sidenav.sticky").position().top-100;$(".sidenav.sticky").height(t)}if($(".site-header").hasClass("sticky")&&!$(".site-header").hasClass("navbar-sm")){var a=!1;$(".site-header").hasClass("navbar-lg")&&(a=!0),$(window).on("scroll",function(){var e=$(".site-header").offset().top+$(".site-header").height();$(window).scrollTop()>e?(a&&$(".site-header").removeClass("navbar-lg"),$(".site-header").addClass("navbar-sm")):(a&&$(".site-header").addClass("navbar-lg"),$(".site-header").removeClass("navbar-sm"))})}if($(".site-header").hasClass("navbar-transparent")&&$(".site-header").hasClass("sticky")&&(0==$(".site-header > .banner").length?$(".site-header").removeClass("navbar-transparent"):$(".site-header").hasClass("sticky")&&$(window).on("scroll",function(){var e=$(".site-header .navbar").height();$(window).scrollTop()>e?$(".site-header").removeClass("navbar-transparent"):$(".site-header").addClass("navbar-transparent")})),$(".site-header").hasClass("sticky")&&0==$(".site-header > .banner").length&&$(".site-header").css("padding-top",$(".site-header > .navbar").height()+30),$(".navbar-brand").prepend('<span class="force-middle"></span>'),$('[data-toggle="offcanvas"]').on("click",function(){$("body").toggleClass("open-sidebar"),$("body").hasClass("open-sidebar")?($("html").css("overflow","hidden"),$(".site-header .jumbotron").slideUp(50)):($("html").css("overflow","visible"),$(".site-header .jumbotron").slideDown(900))}),$(".sidenav.dropable > li > a").on("click",function(e){if(0<$(this).next("ul").length&&e.preventDefault(),0!=$(this).next("ul").length){if($(this).hasClass("open"))return void $(this).removeClass("open").next("ul").slideUp(300);$(this).parents(".sidenav").find("> li > a").removeClass("open"),$(this).parents(".sidenav").find("ul").not(":hidden").slideUp(300),$(this).addClass("open").next("ul").slideDown(300)}}),$(".sidenav.dropable > li > a.active").addClass("open"),$(".sidenav.dropable > li > ul").prev("a").addClass("has-child"),$(window).width()<768&&$(".sidebar-boxed").removeClass("sidebar-dark"),$(".sidenav").hasClass("sticky")&&$(window).on("scroll",function(){var e=$(".sidenav"),i=$(".sidebar").offset();$(window).scrollTop()>i.top?e.css({position:"fixed",top:"100px"}):e.css("position","static")}),$("h1[id], h2[id], h3[id], h4[id], h5[id], h6[id]").each(function(e,i){var t='<a href="#'+$(this).attr("id")+'">'+$(this).html()+"</a>";$(this).html(t)}),jQuery.expr[":"].icontains=function(e,i,t){return jQuery(e).text().toUpperCase().indexOf(t[3].toUpperCase())>=0},$(".faq-search").on("keyup",function(e){var i=$(this).val().trim(),t=$(this).parent().find("li");return""===i?(t.show(),!0):(t.not(":icontains("+i+")").hide(),void t.filter(":icontains("+i+")").show())}),$(".faq li > h6").on("click",function(){$(this).toggleClass("open").next("div").slideToggle(300)}),$.fn.mediaelementplayer&&$("video").mediaelementplayer(),$.fn.fitVids&&$(".video").fitVids(),$(".file-tree li.is-file").on("click",function(e){e.stopPropagation()}),$(".file-tree li.is-folder").on("click",function(e){$(this).find("ul:first").slideToggle(400,function(){$(this).parent("li").toggleClass("open")}),e.stopPropagation()}),$("pre").each(function(e,i){$(this).prepend('<a class="btn btn-sm btn-purple clipboard-copy" data-original-title="Copied!">Copy</a>')}),$("pre").each(function(e,i){if(!$(this).parents(".code-window").length&&!$(this).parents(".code-taps").length){var t="";$(this).children("code").attr("class")&&(t=$(this).children("code").attr("class"),t=t.replace("language-",""),t=t.toLowerCase(),"markup"==t&&(t="html"));var a='<span class="language-name">'+t+"</span>";$(this).prepend(a)}}),$("pre .language-name").parent().on("scroll",function(){$(this).find(".language-name").css("transform","translate("+$(this).scrollLeft()+"px, "+$(this).scrollTop()+"px)")}),$(".code-window").each(function(e,i){var t='<div class="window-bar"><div class="circles">';t+='<span class="circle circle-red"></span> <span class="circle circle-yellow"></span> <span class="circle circle-green"></span>',$(this).attr("data-title")&&(t+='<span class="window-title">'+$(this).data("title")+"</span>"),t+="</div>",$(this).children().length>1&&(t+='<div class="languages"><div class="btn-group" data-toggle="buttons">',$(this).children(":not(.prism-show-language)").each(function(e,i){var a="",s="",n="";0==e&&(a=" active",s=" checked"),$(this).children("code").attr("class")?(n=$(this).children("code").attr("class"),n=n.replace("language-",""),n=n.toLowerCase(),"markup"==n&&(n="html")):$(this).hasClass("code-preview")&&(n="Example"),t+='<label class="btn'+a+'"><input type="radio" autocomplete="off"'+s+">"+n+"</label>"}),t+="</div></div>"),t+="</div>",$(this).children(":not(:first)").hide(0),$(this).children().wrapAll('<div class="window-content"></div>'),$(this).prepend(t);var a=$(this).children(".window-content");$(this).find(".btn-group .btn").on("click",function(){var e=$(this).index();a.children(":visible").fadeOut(200,function(){a.children(":not(.prism-show-language):eq("+e+")").fadeIn(200)})})}),$(".code-tabs").each(function(e,i){var t="";$(this).children().length>1&&(t+='<div class="languages"><div class="btn-group" data-toggle="buttons">',$(this).children(":not(.prism-show-language)").each(function(e,i){var a="",s="",n="";0==e&&(a=" active",s=" checked"),$(this).children("code").attr("class")?(n=$(this).children("code").attr("class"),n=n.replace("language-",""),n=n.toLowerCase(),"markup"==n&&(n="html")):$(this).hasClass("code-preview")&&(n="Example"),t+='<label class="btn'+a+'"><input type="radio" autocomplete="off"'+s+">"+n+"</label>"}),t+="</div></div>"),$(this).children(":not(:first)").hide(0),$(this).children().wrapAll('<div class="window-content"></div>'),$(this).prepend(t);var a=$(this).children(".window-content");$(this).find(".btn-group .btn").on("click",function(){var e=$(this).index();a.children(":visible").fadeOut(200,function(){a.children(":not(.prism-show-language):eq("+e+")").fadeIn(200)})})}),$("pre code").each(function(){$(this).html($.trim($(this).html()))}),$(".code-preview .clipboard-copy").remove(),$(".clipboard-copy").tooltip({placement:"bottom",trigger:"manual"}),$(".clipboard-copy").parent().on("scroll",function(){$(this).find(".clipboard-copy").css("transform","translate("+$(this).scrollLeft()+"px, "+$(this).scrollTop()+"px)")}),$(".clipboard-copy").length>0){var s=new Clipboard(".clipboard-copy",{target:function(e){return e.nextElementSibling}});s.on("success",function(e){e.clearSelection(),$(e.trigger).tooltip("show"),setTimeout(function(e){$(e.trigger).tooltip("hide")},1e3,e)})}});